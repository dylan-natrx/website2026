	...
	'activation' => array(
		...
		'product' => array(
			...
			'select-box-values' => array(
				's6-studio'	=> 'Studio License',
				's6-single-to-studio' => 'Studio License (Upgrade from Single)',
				's6-business'	=> 'Business License',
				's6-single-to-business'	=> 'Business License (Upgrade from Single)',
				's6-studio-to-business' => 'Business License (Upgrade from Studio)',
