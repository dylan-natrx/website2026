...
$general = array(
	...
	'homepage' => array(
		...
		'description' => 'Choose what to display on your homepage. <br /><br /><span class="warning">&mdash; Notice</span><br />The portfolio homepage and the blog homepage<br />should not be the same! Instead select \'Latest Posts\' if you want to show your latest blog posts on the homepage.',
		'break' => '1,2',
		'show_on_front' => array(
	...
	'frontend_mode' => array(
		'title' => 'Frontend Mode',
		'description' => '\'Single Page App\' means your website loads new content without page reloads to create a better flow and seamless page transitions. If you prefer the classic version with normal page reloads, select \'Static\'. Please note that custom page transitions are not supported in \'Static\' mode. You can customize your page transitions <a href="#customize/transitions">here</a>.<br /><br /><span class="warning">&mdash; Notice</span><br />The \'Single Page App\' mode is experimental. If you experience issues with plugins or if you miss some blog functionality (such as archives) please use the \'Static\' mode instead.',
		'frontend_mode' => array(
			'data-input-type' 			=> 'switch',
			'hide-title'				=> true,
			'switch-type'				=> 'twoway',
