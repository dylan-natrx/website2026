...
$advanced = array(
	...
	'progress-bar' => array(
		'title'	 		=> 'Progress Bar',
		'description' 	=> 'Define the color of your \'Progress Bar\'. The progress bar will get displayed once you click a link and a new page gets loaded. (enabled single page app mode is required)',
		'progress_bar' => array(
			'title'			=> 'Color',
			'size'			=> 'span1',
			'data-input-type'	=> 'color',
	...
	'exclusive-navigation' => array(
		'title'	 		=> 'Exclusive Navigation',
		'description' 	=> 'An exclusive navigation overwrites all other individually assigned navigations or hidden navigations and will not be animated as part of page transitions. This is in particular useful for container navigations. <br /><br />Note: An exclusive nav will be always sticky, even on mobile breakpoints.',
		'exclusive_navbar' => array(
			'title'				 => 'Exclusive Navigation',
			'hide-title'		 => true,
			'size'				 => 'span2',
			'data-input-type'    => 'select-box',
