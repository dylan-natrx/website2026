		...
		'options' => array(
			'preview-transition' => array(
				...
				'preview' => array(
					...
					'class'				=> 'admin-listen-handler semplice-button semplice-button-disabled regenerate-transitions',
			...
			'reveal_transition' => array(
				...
				'rt_easing' => array(
					...
					'select-box-values' => $atts->easings,
				),
				'rt_offset' => array(
			...
			'staggered_transition' => array(
				'title' 		=> 'Staggered Reveal Transition',
				'break' 		=> '2,1,2,2',
				'style-class'	=> 'ov-status-enabled ep-collapsed staggered-transition-options',
				'st_mode' => array(
					'data-input-type'			=> 'select-box',
					...
					'style-class'				=> 'ov-status-enabled',
					'data-visibility-switch' 	=> true,
					'data-visibility-values' 	=> 'wave,waterfall',
					'data-visibility-prefix'	=> 'ov-st-mode',
					'select-box-values' => array(
						'wave'	 	=> 'Wave',
						'waterfall'	=> 'Waterfall',
					),
				...
				'st_direction' => array(
					...
					'data-handler'  			=> 'transitions',
					'default' 	 				=> 'ver',
					'style-class'				=> 'ov-st-mode-waterfall',
					'switch-values' => array(
						'ver'	 	=> 'Vertical',
						'hor'		=> 'Horizontal',
					),
				...
				'st_delay' => array(
					...
					'data-divider'		=> 1000,
					'data-range-slider' => 'transitions',
					'help'				=> 'Define the delay in miliseconds after each line should get animated.',
				),
			),
			...
			'optimize-options' => array(
				...
				'break'		 	=> '1,2,2',
				'style-class'	=> 'ov-status-enabled relative',
				'hide-title'	=> true,
