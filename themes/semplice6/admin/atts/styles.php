...
$styles = array(
	...
	// column inner styling
	'column_inner' => array(
		'padding' => $atts->get('styles', array('type' => 'padding', 'target' => '.content-wrapper', 'prefix' => 'contentwrapper_')),
		'background-color' => array(
			'title' => 'Background Options',
			'break'	=> '1',
			'data-hide-mobile' => true,
			'style-class' => 'no-spacer bg-options',
			'contentwrapper_background-color' => array(
				'title'			=> 'Color',
				'hide-title'	=> true,
				'size'			=> 'span4',
				'data-input-type'	=> 'color',
				'data-target'	=> '.content-wrapper',
				'default'		=> 'transparent',
				'class'			=> 'color-picker admin-listen-handler',
				'data-picker'	=> 'style',
				'data-handler'  => 'colorPicker',
		...
		'background-type' => array(
			...
			'style-class' => 'no-spacer bg-type-switch',
			'data-hide-mobile' => true,
			'contentwrapper_background_type' => array(
				'data-input-type' 			=> 'switch',
				'switch-type'				=> 'twoway',
				'title'		 				=> 'Background Type',
				'hide-title'				=> true,
				...
				'data-visibility-switch' 	=> true,
				'data-visibility-values' 	=> 'img,vid',
				'data-visibility-prefix'	=> 'ov-contentwrapper-bg-type',
				'default' 	 				=> 'img',
				'class'						=> 'editor-listen',
				'data-handler'  			=> 'backgroundVideo',
				'switch-values' => array(
		...
		'background-image' => $atts->get('styles', array('type' => 'background-image', 'target' => '.content-wrapper', 'prefix' => 'contentwrapper_')),
		'background-video' => $atts->get('styles', array('type' => 'background-video', 'target' => '.content-wrapper', 'prefix' => 'contentwrapper_')),
		'box-shadow' => $atts->get('styles', array('type' => 'box-shadow', 'target' => '.content-wrapper', 'prefix' => 'contentwrapper_')),
		'border' => $atts->get('styles', array('type' => 'border', 'target' => '.content-wrapper', 'prefix' => 'contentwrapper_')),
	),
