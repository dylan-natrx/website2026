...
if($args['type'] == 'padding') {
	...
	} else if($args['target'] == '.content-wrapper') {
		$options['has-media'] = 'wrapperStyles,background-image';
		$options['style-class'] = 'ov-contentwrapper-bg-type-img bg-img-upload';
	...
	if($args['target'] == '.container') {
		...
		$options['style-class'] = 'ov-contentwrapper-bg-type-vid';
	}
} else if($args['type'] == 'border') {
	$options = array(
		'title' => 'Border',
		'help' => 'Note: Border radius will be used for all directions despite the \'Direction\' setting.',
		'break'	=> '1,4',
		'style-class' => 'ep-collapsed',
		$args['prefix'] . 'border-direction' => array(
			'title'			=> 'Direction',
			'size'			=> 'span4',
			'data-input-type' 	=> 'select-box',
			'data-target'	=> $args['target'],
