...
$options = array(
	...
	// mobile options
	'responsive-lg' => $atts->get_mobile('section_options', 'Desktop', 'lg', false),
	'responsive-md' => $atts->get_mobile('section_options', 'Tablet Wide', 'md', false),
	'responsive-sm' => $atts->get_mobile('section_options', 'Tablet Portrait', 'sm', false),
	'responsive-xs' => $atts->get_mobile('section_options', 'Phone', 'xs', false),
);
