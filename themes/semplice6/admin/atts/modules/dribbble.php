...
$dribbble = array(
	...
	'gutter_responsive_lg' => $atts->get_mobile('gutter', '', 'lg', array('images_per_row' => true)),
	'gutter_responsive_md' => $atts->get_mobile('gutter', '', 'md', array('images_per_row' => true)),
	'gutter_responsive_sm' => $atts->get_mobile('gutter', '', 'sm', array('images_per_row' => true)),
	'gutter_responsive_xs' => $atts->get_mobile('gutter', '', 'xs', array('images_per_row' => true)),
);
