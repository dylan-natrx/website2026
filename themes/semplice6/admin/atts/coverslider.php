...
// vp button options
$vp_button_options = $atts->get('vpbutton', array('is_slider' => true));
	...
	'options' => array(
		'preview' => array(
			...
			'posts' => array(
				...
				'size'		 		=> 'span4',
				'class'				=> 'semplice-button coverslider-preview admin-click-handler regenerate-coverslider',
		...
		'main' => array(
			...
			'hide_post_cover' => array(
				...
				'help'						=> 'For a better user experience you can hide the cover on the project or page you are navigating to with the \'View Project\' button from the coverslider. The covers will be still visible if you visit them from any other link. (portfolio grid, direct link, google etc.)<br />br />This only works with the "View Project" button, not with a custom added button.',
				'size'		 				=> 'span4',
				'class'						=> 'editor-listen',
				'data-handler'				=> 'coverSlider',
				'default' 	 				=> 'disabled',
