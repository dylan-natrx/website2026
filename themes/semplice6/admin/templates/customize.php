	...
	<div class="customize-inner">
		<div class="customize-heading">
			<div class="inner footer-inner">
				<div class="admin-row">
					<div class="sub-header admin-column">
						<h2 class="admin-title">Footer <a class="admin-click-handler semplice-button gray-button" data-handler="execute" data-action="addPost" data-action-type="main" data-post-type="footer">Add New Footer</a></h2>
					</div>
				</div>
			</div>
		</div>
