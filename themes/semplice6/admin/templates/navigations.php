			...
			<div class="inner navigations-inner">
				<div class="admin-row">
					<div class="sub-header admin-column">
						<h2 class="admin-title">Navigations<a class="semplice-button gray-button" href="#customize/navigations/add">Add Navigation</a></h2>
					</div>
				</div>
			</div>
		</div>
...
<script id="navigations-presets-template" type="text/template">
	<?php
		...
		$navigations = array(
			...
			'preset_twelve' => array(
				'system_name' => 'container_floating',
				'display_name' => 'Container floating',
				'hidden' => false,
			),
			'preset_thirteen' => array(
				'system_name' => 'container_expanded',
				'display_name' => 'Container Expanded',
				'hidden' => false,
			),
		);
		// studio navs
