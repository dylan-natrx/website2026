...
<script id="ep-post-options-link-template" type="text/template">
	<div class="option">
		<div class="option-inner">
			<div class="attribute span4">
				<h4>External Link</h4>
				<input type="text" name="post_link" class="editor-listen" data-handler="epPostOptions" value="{{link}}" placeholder="https://www.semplice.com" data-content-id="{{contentId}}" data-post-id="{{postId}}" data-input-type="text">
			</div>
		</div>
	</div>
</script>
