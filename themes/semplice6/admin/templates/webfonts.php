			...
			<div class="inner">
				<div class="admin-row">
					<div class="sub-header admin-column">
						<h2 class="admin-title">Webfonts<a class="admin-click-handler semplice-button gray-button" data-handler="execute" data-action="addWebfontPopUp" data-setting-type="webfonts" data-action-type="customize" data-options="add-font" data-mode="add">Add webfont</a></h2> 
					</div>
				</div>
			</div>
		</div>
...
<script id="webfonts-ressource-default-fonts-template" type="text/template">
	<div class="default-fonts-switch">
		<h5 class="ressource-name">Default Fonts</h5>
		<div class="option">
			<div class="option-inner">
				<div class="attribute">
					<div class="onoff-switch">
						<div class="switch admin-click-handler switch-{{val}}" data-handler="onOffSwitch">
							<div class="circle"></div>
							<input type="hidden" name="default_fonts" value="{{val}}" data-input-type="onoff-switch" class="admin-listen-handler" data-handler="defaultFontsSwitch" data-on="on" data-off="off" data-unique-name="default_fonts">
						</div>
					</div>
				</div>
			</div>
