...
<!-- reset template-->
<script id="reset-template-template" type="text/template">
	<div id="enable-transitions" class="popup">
		<div class="popup-inner">
			<div class="popup-close admin-click-handler" data-handler="hidePopup">
				<?php echo get_svg('backend', '/icons/popup_close'); ?>
			...
			<div class="popup-content">
				...
				<p>This will reset your {{label}} template to the default version. Please note that all of your editings and additions will be gone.</p>
			</div>
			<div class="popup-footer">
			<a class="admin-click-handler cancel" data-handler="hidePopup">Cancel</a><a class="admin-click-handler confirm semplice-button delete-button" data-handler="execute" data-action-type="customize" data-action="resetTemplate" data-setting-type="blog" data-template="{{template}}">Reset Template</a>
			</div>					
		</div>
	</div>
</script>
