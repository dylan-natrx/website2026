...
<script id="update-template" type="text/template">
	<div class="semplice-update">
		<div class="inner">
			<p><span>Update available!</span> New version: {{newVersion}} &mdash; <a href="https://www.semplice.com/changelog-v6-<?php echo semplice_theme('edition'); ?>" target="_blank">Changelog</a></p>
...
<script id="wrong-folder-template" type="text/template">
	<div class="wrong-folder">
		...
		<p>To activate the Semplice One-click Update, your theme root folder must be called <span>/semplice6</span>. At the moment your theme root folder is: <span>/<?php echo get_template(); ?></span>. Please <a href="https://help.semplice.com/hc/en-us/articles/360035159731" target="_blank">read our small guide</a> on how to change that. Don't worry it's pretty easy and straight forward.</p>
	</div>
</script>
<!-- theme settings template -->
<script id="settings-template" type="text/template">
	<div id="settings" class="{{class}}">
		<div class="customize-heading">
			<div class="inner settings-header">
				<div class="admin-row">
	...
	<div id="activate-semplice" class="popup">
		...
		<div class="popup-inner">
			<div class="popup-content">
				<h3>Edit with Semplice v6</h3>
				<p>This page was created with an older version of Semplice or another theme. The content is not compatible with Semplice v6. You can click "Start editing" to edit the page with the current version, but you won’t be able to see or edit the original content within Semplice.</p>
			</div>
...
<script id="semplice-activated-template" type="text/template">
	<div class="semplice-activated">
		...
		<p class="license-infos">
			Installed Version: <a href="https://www.semplice.com/changelog-v6-{{changelog}}" target="_blank"><?php echo semplice_theme('version'); ?></a><br />
