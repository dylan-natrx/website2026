...
<!-- select filter -->
<script id="select-taxonomy-template" type="text/template">
	...
	<div class="animate-effects-list">
		<div class="ael-inner">
			...
			<ul>
				...
				<li><a class="editor-action" data-action-type="animate" data-action="addEffect" data-effect="reveal" data-id="{{id}}" data-step="{{step}}">Reveal</a></li>
			</ul>
		</div>
	</div>
