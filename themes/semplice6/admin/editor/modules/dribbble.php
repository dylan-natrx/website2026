...
if(!class_exists('sm_dribbble')) {
	...
	class sm_dribbble {
		...
		public function output_editor($values, $id) {
			...
			if($media == 'curl') {
				...
				$this->output['html'] = semplice_module_placeholder('dribbble', $connect_message, false, $this->is_editor, $id);
				...
				$this->output['html'] = semplice_module_placeholder('dribbble', 'Wrong or no access token.', false, $this->is_editor, $id);
			}
	...
	// instance
	editor_api::$modules['dribbble'] = new sm_dribbble;
}