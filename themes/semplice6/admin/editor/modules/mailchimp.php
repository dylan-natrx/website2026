...
if(!class_exists('sm_mailchimp')) {
	class sm_mailchimp {
		...
		public function output_editor($values, $id) {
			...
			$css .= '
				...
				#content-holder #' . $id . ' input::placeholder { color: ' . $input_holder_color . ';	}
				#content-holder #' . $id . ' input:hover::placeholder { color: ' . $input_holder_mouseover_color . ';	}
	...
	// instance
	editor_api::$modules['mailchimp'] = new sm_mailchimp;
}