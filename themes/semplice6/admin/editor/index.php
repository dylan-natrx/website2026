<div id="semplice-editor" class="active-content" data-mode="default">
	...
	<!-- accordion toolbar -->
	<div id="accordion-toolbar">
		<div class="accordion-mode"><span><?php echo get_svg('backend', '/icons/module_accordion'); ?></span></div>
		<div class="accordion-desc">Accordion Editor</div>
		<a class="accordion-save"></a>
	</div>

	<!-- animate toolbar -->
	<div id="animate-toolbar">
		<div class="motions-mode"><span><?php echo get_svg('backend', '/icons/animate_topbar'); ?></span></div>
		<div class="animations-desc">Animation Editor</div>
	...
	<div id="semplice-tools">
		...
		<div class="semplice-tools-motions">
			<a class="editor-action animate-init" data-handler="execute" data-action-type="animate" data-action="init"><span><?php echo get_svg('backend', '/icons/animate_switch'); ?></span><span class="animate-switch-active"><?php echo get_svg('backend', '/icons/animate_switch_active'); ?></span></a>
			<div class="animate-tooltip tooltip">Animations</div>
		</div>
		<div class="semplice-tools-grid">
			<a class="editor-action show-grid" data-handler="execute" data-action-type="helper" data-action="showGrid" data-mode="section"><?php echo get_svg('backend', '/icons/show_grid'); ?></a>
