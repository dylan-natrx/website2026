...
<script id="reset-changes-template" type="text/template">
	<div id="breakpoint-reset-changes" class="popup">
		<div class="popup-inner">
			...
			<div class="popup-footer">
				<a class="admin-click-handler cancel" data-handler="hidePopup">Cancel</a><a class="editor-action confirm semplice-button" data-action="resetChanges" data-action-type="helper" data-content-id="{{id}}" data-mode="all">Reset Changes</a>
			</div>					
		</div>
	</div>
</script>
...
<script id="copy-styles-template" type="text/template">
	<div id="breakpoint-copy-styles" class="popup">
		<div class="popup-inner">
			...
			<div class="popup-footer">
			<a class="admin-click-handler cancel" data-handler="hidePopup">Cancel</a><a class="editor-action confirm semplice-button" data-action="copyStyles" data-action-type="helper" data-content-id="{{id}}" data-val="{{val}}">Copy Changes</a>
			</div>					
		</div>
	</div>
</script>
