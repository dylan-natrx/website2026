...
$lottie = array(
	...
	'lottie-playback' => array(
		...
		'pin_duration' => array(
			...
			'class'			=> 'editor-listen',
			'data-handler'  => 'save',
			'help'			=> 'Example: 50 means that the animation will finish once you scroll 50% of your browser height.<br /><br />This setting will only take effect if \'Pin\' is set to \'Yes\'',
			'style-class' => 'ov-lottie-trigger-on_scroll',
		),
		'pin' => array(
			'data-input-type' => 'switch',
